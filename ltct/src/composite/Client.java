...
public class Client {
    public static void main(String[] args) {
        ...
        folder.showProperty();
        List<FileComponent> fileTest2 = Arrays.asList(folder,file1,file2,file3);
        FileComponent folderTest2 = new FolderComposite(fileTest2);
        System.out.println(folderTest2.totalSize());
    }
}
